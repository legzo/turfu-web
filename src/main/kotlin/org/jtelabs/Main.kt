...
private fun simulate(
    ...
    val limitOccurences = limitOccurencesTo(occurences)
    val filterWithTopPlace = filterWithTopPlaceFromSynthese(topPlaceSynthese, synthese)
    val excludeNonPartants = excludeNonPartants(nonPartants)
    ...
    listOf(
        ...
        val result = filter.invoke(acc)
        logger.info("Invoked : $filter, nb of combinations : ${result.size}")
        result
    }
